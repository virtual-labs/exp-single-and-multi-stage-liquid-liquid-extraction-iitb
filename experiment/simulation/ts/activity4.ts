...
var v1: number = 5;
var N2: number = 0.926;
var rho_acetic_acid: number = 1;
var rho_benzene: number = 0.87;
var N1: number = 3.6;
var vs: number = 128;
...
function activity4() {
    ...
    pp.showdescription(
      '<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 2.5vw;">Click Next button to Start Titration</p>', 3);
...
function load_dropdowns() {
  ...
  pp.showdescription(
    '<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: 2.5vw;">Now we will start the Titration</p>', 3);
...
function perform() {
  ...
  let image: HTMLImageElement = <HTMLImageElement> document.getElementById('titration-image');
