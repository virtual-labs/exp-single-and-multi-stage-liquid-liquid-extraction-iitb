...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(beaker, new Chemistry.Point(600, 400), 185, 259, canvas);
    sq.name = "beaker";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(burette, new Chemistry.Point(1450, 450), 70, 512, canvas);
    sq.name = "burette";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(flask, new Chemistry.Point(1650, 600), 139, 242, canvas);
    sq.name = "flask";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(s_funnel, new Chemistry.Point(1000, 500), 194, 432, canvas);
    sq.name = "s_funnel";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(stand, new Chemistry.Point(250, 500), 302, 536, canvas);
    sq.name = "stand";
    scene.add(sq);
}
...
function a1_load_questions() { }
{
    ...
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Burette </span>", ans: "burette", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    ...
    question.push({ srno: 4, question: "Select <span style='color: #018fc3'> Separatory Funnel </span>", ans: "s_funnel", hint: ["Double Pipe", "pipe inside a pipe", "Has two inlets and outlets"] });
    question.push({ srno: 5, question: "Select <span style='color: #018fc3'> Stand </span>", ans: "stand", hint: ["U-Shape", "Mounted horizontally", "Has two pins"] });
}
